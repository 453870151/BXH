...
class BxhStakePC extends Component {
        ...
        <div className={getStyleClass('PCbroot',classes.root)}>
          ...
          <div className={classes.root1}>
            <div className={ classes.bxhtTit }>
              <h2>BXH Pool</h2>
              <h3>{t('BXH.diyatitle')} {pair&&pair.symbolPair_Show&&pair.symbolPair_Show!==""?pair.symbolPair_Show:""} {t('BXH.zhiyapctip')}</h3>
            </div>
...
export default withNamespaces()(withRouter(withStyles(styles)(BxhStakePC)));
