...
class BXHMortgageBackDialog extends Component {
  constructor(props){
    super(props);
  ...
  renderCard = () => {
    ...
    let chainID = localStorage.getItem('chainIDSwitch')
    return (
        <Card className={[classes.card, chainID === '56' ? 'bscPCDialogbg' : 'hecoPCDialogbg'].join(' ')}>
            ...
            <div className={classes.cardRow}>
                <img src={ bxhAsset&&bxhAsset.logoURI ? bxhAsset.logoURI : '' } alt='' className={classes.coinLogo}/>
                <label style={{marginLeft:'5px'}}>
                    {
                        (bxhAsset&&bxhAsset.symbol)||" "
                    }
                </label>
            </div>
            <div className={classes.cardTipInput}>
                <label>{t('BXH.input')}</label>
                <label><span style={{color:'rgba(255,255,255,0.4)',marginRight:'5px'}}>{type==='0' ? t('BXH.canMortgageNumber') : t('BXH.canRetrieveNumber')}:</span>{numberDecimal(parseFloat(balance))||"--"}</label>
            </div>
            <div className={classes.cardInput}>
                <TextField
                    ...
                    />
                <div className={[classes.bxhmax, chainID === '56' ? 'bscPCDialogmax' : 'hecoPCDialogmax'].join(' ')} onClick={ this.MAXBalance }>MAX</div>
            </div>
            {
                chainID === '56' ?
...
export default withNamespaces()(withRouter(withStyles(styles)(BXHMortgageBackDialog)));
