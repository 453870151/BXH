...
class OpeningUnlock extends Component {
...
function MyComponent(props) {
  ...
  return (
    <div style={{ display: 'flex', flexWrap: 'wrap', color: '#333', justifyContent: (width > 650 ? 'space-between' : 'center'), alignItems: 'center' }}>
      Comming Soon
    </div>
  )
...
export default withNamespaces()(withRouter(withStyles(styles)(OpeningUnlock)));
