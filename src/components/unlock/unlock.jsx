        ...
        {/* {
          isMobile ? 
            ...
            <div className={ classes.root }>
              ...
              <div className={ classes.contentContainer }>
                <Web3ReactProvider getLibrary={getLibrary}>
                  <MyMobileComponent closeModal={ closeModal} t={t} />
                </Web3ReactProvider>
              </div>
            </div>
            :
    ...
    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: (width > 650 ? 'space-between' : 'center'), alignItems: 'center' }}>
      {Object.keys(connectorsByName).map(name => {
        ...
        if (name === 'MetaMask') {
          ...
          url = require('../../assets/icn-bitkeep.png')
        } else if(name === 'TokenPocket'){
          url = require('../../assets/icn-TokenPocket.png')
...
// 移动端连接钱包
function MyMobileComponent(props) {
