...
class MortgageSingleBackDialog extends Component {
  constructor(props){
    super(props);
    const { t, onClose, onSure, type ,tokensData,pairData} = this.props;
    console.log("接收到的数据---->>>>>>",tokensData)
  ...
  onChangeTo = (value, event) => {
    // this.state.tokensData.userInfo.amount //取回流动性
    // this.state.tokensData.mineLpAmount //抵押
    // type==='0' ? '抵押' : '取回'
...
export default withNamespaces()(withRouter(withStyles(styles)(MortgageSingleBackDialog)));
