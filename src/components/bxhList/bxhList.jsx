...
class BxhList extends Component {
  ...
  constructor(props) {
    ...
    const StakedPoolRegularList = JSON.parse(localStorage.getItem("StakedPoolRegularList"))
    ...
    this.state = {
      ...
      StakedPoolRegularList: StakedPoolRegularList,
      currentType_sort: 0,
      currentIndex_sort: 1,
      open: false,
      footerMShow: true,
    ...
    store._getMineStakedPoolRegular((stakedList) => { // 单币质押--定期
      localStorage.setItem("StakedPoolRegularList", JSON.stringify(stakedList));
      store.setStore({ StakedPoolRegularList: stakedList })
      this.setState({ StakedPoolRegularList: stakedList })
    })
  }
          ...
          <div className={getStyleClass('TabConter',classes.areatype)}>
              {/* 单币质押v2--活期 */}
              {
                ...
                onClick={() => {this.changeSelectIndex(6)}}>
                  {t('BXH.liquerPool')} ({t('BXH.current')})<em></em>
                </span>
                :
              ...
              {/* 单币质押(定期) */}
              {
                <span className={currentSelectindex === 8 ? "bxhTabOn" : "bxhTabOff"} 
                onClick={() => { this.changeSelectIndex(8) }}>
                  {t('BXH.liquerPool')} ({t('BXH.regular')})<em></em>
                </span>
              }
  ...
  // 新质押(定期)--列表Data
  renderListNewSingleData = () => {
    const { classes, t } = this.props
    const { isMobile, PoolList, currentSelectindex, currentType_sort, currentIndex_sort } = this.state
    let PoolDataList = PoolList && PoolList[0].tokens[0].symbolTokens
    let chainID = localStorage.getItem('chainIDSwitch')
    return (
      <div className={classes.regularOverflowX}>
        {
          <div className={classes.regularWidth}>
            {/* 交易对 */}
            <div className={[classes.tiaomu].join(' ')} style={{width:'10%',textAlign:'left'}}>
              {t('BXH.jiaoyiduititle')}
            </div>
            {/* 产量 */}
            <div className={classes.tiaomu} style={{width:'15%'}}>
              <div className={classes.regularItem}>
                {
                  <div onClick={() => { this.changeSortType(4) }}>{t('BXH.daymonthlyoutput')}</div>
                }
                {
                  currentType_sort === 4 ?
                    currentIndex_sort !== 1 ?
                      currentIndex_sort === 2 ?
                        <img src={require('../../assets/bxh/sort_up.png')} onClick={() => { this.changeSortType(4) }} />
                        :
                        <img src={require('../../assets/bxh/sort_down.png')} onClick={() => { this.changeSortType(4) }} />
                      :
                      <img src={require('../../assets/bxh/sort_normal.png')} onClick={() => { this.changeSortType(4) }} />
                    :
                    <img src={require('../../assets/bxh/sort_normal.png')} onClick={() => { this.changeSortType(4) }} />
                }
              </div>
            ...
            {/* 锁仓周期 */}
            {
              ...
              <div className={classes.tiaomu} style={{width:'15%'}}>
                <div className={classes.regularItem}>
                  <div onClick={() => {this.changeSortType(7)}}>APR</div>
                  {
                    currentType_sort === 7 ?
                      currentIndex_sort !== 1 ?
                        currentIndex_sort === 2 ?
                          <img src={require('../../assets/bxh/sort_up.png')} onClick={() => { this.changeSortType(7) }} />
                          :
                          <img src={require('../../assets/bxh/sort_down.png')} onClick={() => { this.changeSortType(7) }} />
                        :
                        <img src={require('../../assets/bxh/sort_normal.png')} onClick={() => { this.changeSortType(7) }} />
                      :
                      <img src={require('../../assets/bxh/sort_normal.png')} onClick={() => { this.changeSortType(7) }} />
                  }
                </div>
              ...
              <div className={classes.tiaomu} style={{width:'15%'}}>
                <div className={classes.regularItem}>
                  <div onClick={() => { this.changeSortType(5) }}>{t('BXH.lockupCycle')}</div>
                  {
                    currentType_sort === 5 ?
                      currentIndex_sort !== 1 ?
                        currentIndex_sort === 2 ?
                          <img src={require('../../assets/bxh/sort_up.png')} onClick={() => { this.changeSortType(5) }} />
                          :
                          <img src={require('../../assets/bxh/sort_down.png')} onClick={() => { this.changeSortType(5) }} />
                        :
                        <img src={require('../../assets/bxh/sort_normal.png')} onClick={() => { this.changeSortType(5) }} />
                      :
                      <img src={require('../../assets/bxh/sort_normal.png')} onClick={() => { this.changeSortType(5) }} />
                  }
                </div>
            ...
            <div className={classes.tiaomu} style={{width:'15%'}}>
              <div className={classes.regularItem}>
                <div onClick={() => { this.changeSortType(6) }}>TVL</div>
                {
                  currentType_sort === 6 ?
                    currentIndex_sort !== 1 ?
                      currentIndex_sort === 2 ?
                        <img src={require('../../assets/bxh/sort_up.png')} onClick={() => { this.changeSortType(6) }} />
                        :
                        <img src={require('../../assets/bxh/sort_down.png')} onClick={() => { this.changeSortType(6) }} />
                      :
                      <img src={require('../../assets/bxh/sort_normal.png')} onClick={() => { this.changeSortType(6) }} />
                    :
                    <img src={require('../../assets/bxh/sort_normal.png')} onClick={() => { this.changeSortType(6) }} />
                }
              </div>
            ...
            <div className={classes.tiaomu} style={{width:'15%'}}>
              <div className={classes.regularItem}>
                <div onClick={() => { this.changeSortType(8) }}>{t('BXH.minimum')}</div>
                {
                  currentType_sort === 8 ?
                    currentIndex_sort !== 1 ?
                      currentIndex_sort === 2 ?
                        <img src={require('../../assets/bxh/sort_up.png')} onClick={() => { this.changeSortType(8) }} />
                        :
                        <img src={require('../../assets/bxh/sort_down.png')} onClick={() => { this.changeSortType(8) }} />
                      :
                      <img src={require('../../assets/bxh/sort_normal.png')} onClick={() => { this.changeSortType(8) }} />
                    :
                    <img src={require('../../assets/bxh/sort_normal.png')} onClick={() => { this.changeSortType(8) }} />
                }
              </div>
        ...
        <div className={classes.regularPoolxian}></div>
        {/* 單幣質押--定期 */}
        {
          currentSelectindex === 8 ?
          <div style={{ minHeight: '70px' }}>
            {this.renderBXHSingleNew()}
          </div>
          :
          null
        }
  ...
  checkSinglePoolRegularById = (id) => {
    const { StakedPoolRegularList } = this.state
    if (!StakedPoolRegularList || StakedPoolRegularList.length == 0) {
      return false
    }

    for (let i = 0; i < StakedPoolRegularList.length; i++) {
      let item = StakedPoolRegularList[i]
      if (parseFloat(item.id) === parseFloat(id)) {
        return true
      }
    }
  ...
  //TVL=1 产量=2 APY=3 初始值0 type currentType_sort
  //正常=1 正序=2 倒序=3 初始值1 currentIndex_sort
  changeSortType = (type) => {
    const { currentType_sort, currentIndex_sort } = this.state
    if (type === currentType_sort) {
      let currentIndex_sort_temp = 0
      if (currentIndex_sort == 3) { // 前面倒叙 改成正序
        currentIndex_sort_temp = 2
      } else if (currentIndex_sort == 2) { // 正序 改成正常
        currentIndex_sort_temp = 1
      } else if (currentIndex_sort == 1) { // 正常 改成倒叙
  ...
  sortListByType = (index) => {
    ...
    if (index == 1) {
      ...
      PoolList[0].tokens[0].symbolTokens.bxh_new_staking_pool.map((item) => {
        dataList.push(item)
      })
    }
...
// this.renderShouyi(dataList)
    if (currentType_sort === 0 && currentIndex_sort === 1) {
      ...
      // 以下是单币质押--定期 排序
    } else if (currentType_sort === 4) { // 产量
      if (currentIndex_sort == 2) {
        return dataList.sort((a, b) => { return (parseFloat(a.outputDay) - parseFloat(b.outputDay)) > 0 ? 1 : -1 })
      } else if (currentIndex_sort == 3) {
        return dataList.sort((a, b) => { return (parseFloat(a.outputDay) - parseFloat(b.outputDay)) > 0 ? -1 : 1 })
      }
    } else if (currentType_sort === 5) { // 周期
      if (currentIndex_sort == 2) {
        return dataList.sort((a, b) => { return (parseFloat(a.lockSeconds) - parseFloat(b.lockSeconds)) > 0 ? 1 : -1 })
      } else if (currentIndex_sort == 3) {
        return dataList.sort((a, b) => { return (parseFloat(a.lockSeconds) - parseFloat(b.lockSeconds)) > 0 ? -1 : 1 })
      }
    } else if (currentType_sort === 6) { // tvl
      if (currentIndex_sort == 2) {
        return dataList.sort((a, b) => { return (parseFloat(a.tvlPool) - parseFloat(b.tvlPool)) > 0 ? 1 : -1 })
      } else if (currentIndex_sort == 3) {
        return dataList.sort((a, b) => { return (parseFloat(a.tvlPool) - parseFloat(b.tvlPool)) > 0 ? -1 : 1 })
      }
    } else if (currentType_sort === 7) { // apy
      if (currentIndex_sort == 2) {
        return dataList.sort((a, b) => { return (parseFloat(a.apyPool) - parseFloat(b.apyPool)) > 0 ? 1 : -1 })
      } else if (currentIndex_sort == 3) {
        return dataList.sort((a, b) => { return (parseFloat(a.apyPool) - parseFloat(b.apyPool)) > 0 ? -1 : 1 })
      }
    } else if (currentType_sort === 8) { // 最小投入
      if (currentIndex_sort == 2) {
        return dataList.sort((a, b) => { return (parseFloat(a.depositMin) - parseFloat(b.depositMin)) > 0 ? 1 : -1 })
      } else if (currentIndex_sort == 3) {
        return dataList.sort((a, b) => { return (parseFloat(a.depositMin) - parseFloat(b.depositMin)) > 0 ? -1 : 1 })
      }
    } 
        ...
        <div key={rewardDFKiiPool.id}>
          <div key={rewardDFKiiPool.id} className={classes.listItemParent}>
            ...
            {/* BSC、HECO链单币只显示日产量 */}
            {
              (chainID === '56'||chainID === '128')&&currentSelectindex===5?  
              // 日产量
              <div style={{ width: (chainID === '56'||chainID === '128')&&currentSelectindex===5 ? '15%' : '20%' }}>
            ...
            <div style={{ position: 'relative', width: (chainID === '56'||chainID === '128')&&currentSelectindex===5 ? '25%' : '25%' }}>
  ...
  // 单币质押--定期
  renderBXHRegularStaking = (rewardDFKiiPool, index, isLast) => {
    const { classes, t } = this.props
    const { isMobile, currentSelectindex, PoolList, cPoolArray } = this.state
    let miningAPY = t('BXH.miningAPY') + this.SaveTwoWei(rewardDFKiiPool ? rewardDFKiiPool.apy_pool : 0) + '% + ' + t('BXH.ServiceAPY') + this.SaveTwoWei(rewardDFKiiPool ? rewardDFKiiPool.apy_ex : 0) + '%'
    let chainID = localStorage.getItem('chainIDSwitch')
    ...
    return (
      <div key={rewardDFKiiPool.ex_id}>
        <div key={rewardDFKiiPool.ex_id} className={classes.regularWidth2}
          onClick={() => { this.navigateBXHStakeNewMobile(rewardDFKiiPool,isMobile) }}>
          {/* 交易对 */}
          <div style={{ display: 'flex', width: '10%' }}>
            <div className={classes.poollistImgParent}>
              <img src={rewardDFKiiPool.icon} className={classes.imgStyleNew} />
            </div>

            <div style={{ marginLeft: '2px' }}>
              {
                rewardDFKiiPool.symbol0 ?
                <span style={{ fontWeight: 'bold', fontSize: '14px' }}>{rewardDFKiiPool.symbol0}</span>
                :
                <span style={{ fontWeight: 'bold', fontSize: '14px' }}>{rewardDFKiiPool.symbol1}</span>
              }
            </div>
          </div>
              ...
              <div style={{ fontSize: '15px', textAlign: 'right' }}>
                <em className={classes.rightparent_new}>{rewardDFKiiPool ?
                  (
                    <CountUp
                      start={0}
                      end={this.SaveToTwoWei(rewardDFKiiPool ? rewardDFKiiPool.outputDay : 0)}
                      duration={2.0}
                      separator=","
                      decimals={0}
                      decimal="."
                ...
                ({rewardDFKiiPool ? rewardDFKiiPool.symbolReward : null})
              </div>
              <div style={{ fontSize: '15px', textAlign: 'right' }}>
                <em className={classes.rightparent_new}>{rewardDFKiiPool ?
                  (
                    <CountUp
                      start={0}
                      end={this.SaveToTwoWei(rewardDFKiiPool ? rewardDFKiiPool.outputDay*30 : 0)}
                      duration={2.0}
                      separator=","
                      decimals={0}
                      decimal="."
          ...
          {/* 周期 */}
          {
            isMobile === 2 ?
            // apy
            <div style={{ fontSize: '15px', width: '15%', textAlign: 'right', marginTop: '0px' }}>
              <div className={getStyleClass('PCnew_green',classes.rightparent_new_green)}>
                <CountUp
                  start={0}
                  end={this.SaveToTwoWei(rewardDFKiiPool ? rewardDFKiiPool.apyPool : 0)}
                  duration={2.0}
                  separator=","
                  decimals={2}
                  decimal="."
            ...
            <div style={{ width: '15%', fontSize: '15px', textAlign: 'right' }}>
              <div className={classes.rightparent_new_hint}>
                <span>{this.exchangeSecondToDay(rewardDFKiiPool.lockSeconds)} D</span>
              </div>
            </div>
          }
          ...
          <div style={{ fontSize: '15px', width: '15%', textAlign: 'right' }}>
            <div className={classes.rightparent_new_hint}>
              <CountUp
                start={0}
                end={this.SaveToTwoWei(rewardDFKiiPool ? rewardDFKiiPool.tvlPool : 0)}
                duration={2.0}
                separator=","
                decimals={2}
                decimal="."
          ...
          <div style={{ fontSize: '15px', width: '15%', textAlign: 'right' }}>
            <div className={classes.rightparent_new_hint}>
              <CountUp
                start={0}
                end={this.SaveToTwoWei(rewardDFKiiPool ? rewardDFKiiPool.depositMin : 0)}
                duration={2.0}
                separator=","
                decimals={2}
                decimal="."
          ...
          <div style={{ position: 'relative', width: '15%'}}>
            <div className={classes.regularBt}>
              {
                <div className={getStyleClass('PC_new_btn1',classes.bxhaddmobility_new_btn)} onClick={() => { this.navigateBXHStakeNew(rewardDFKiiPool) }}>{t('BXH.diyatitle')}</div>
              }
            </div>
          </div>
  ...
  renderBXHSingleNew = () => {
    ...
    let dataList = this.sortListByType(8)

    let dataCount = 0
    let dataList_ss = []
    for (let i = 0; i < dataList.length; i++) { 
      if (this.checkSinglePoolRegularById(dataList[i].id) || !isOnlyShowMyJoin) {
        dataCount = dataCount + 1
      }

      const isShow = isOnlyShowMyJoin ? this.checkSinglePoolRegularById(dataList[i].id) : true
      const isInputVal = inputSearchVal === "" ? true : this.checkSymbolbyKey(inputSearchVal, dataList[i].symbol1)
    ...
    if (dataCount > 0) {
      return dataList_ss.map((rewardDFKiiPool1, index) => {
        return this.renderBXHRegularStaking(rewardDFKiiPool1, index, index === dataCount - 1)
      })
    } else{
      return this.renderEmptyData()
    }
  ...
  exchangeSecondToDay(num) { // 秒转天
    if (num && num > 0) {
      return this.SaveTwoWei(num / 3600 / 24)
    } else {
      return '0.00'
    }
  }
  ...
  navigateBXHStakeNew = (rewardPool) => {
    store.setStore({ currentdTradePool: rewardPool })
    document.documentElement.scrollTop = document.body.scrollTop = 0;
    let chainID = localStorage.getItem('chainIDSwitch')
    this.props.history.push('/pledgeRegular/' + rewardPool.ex_id)
  }
  navigateBXHStakeNewMobile = (rewardPool,isMobile) => {
    console.log('点击');
    console.log(isMobile);
    if (isMobile === 2) this.navigateBXHStakeNew(rewardPool)
  }
