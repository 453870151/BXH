...
class CombustionStakeDialog extends Component {
  constructor(props){
    super(props);
    const { t, onClose, onSure, type, obj} = this.props;
    var title = '';
    var tmpType = type;
    var tmpBalance = obj.lpBalance;
  ...
  renderCard = () => {
    ...
    const { type, title, sureEnable, balance, inputVal, obj} = this.state;
    const isMobile = this._isMobile();
    return (
        <Card className={classes.card}>
            ...
            <div className={classes.cardRow}>
                <img src={ obj&&obj.project_icon ? obj.project_icon : ''} alt='' className={classes.coinLogo}/>
            ...
            <div className={classes.cardTipInput}>
                ...
                <label><span style={{color:'rgba(255,255,255,0.4)',marginRight:'5px'}}>{type==0 ? t('BXH.canMortgageNumber') : t('BXH.canRetrieveNumber')}:</span>{balance?SaveToTwoWei(balance,4):"--"}</label>
            </div>
...
export default withNamespaces()(withRouter(withStyles(styles)(CombustionStakeDialog)));
