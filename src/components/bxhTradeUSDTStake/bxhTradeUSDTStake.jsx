...
class BxhTradeUSDTStake extends Component {
        ...
        <div className={getStyleClass('PCbroot',classes.root)}>
          ...
          <div className={classes.root1}>
            <div className={classes.bxhtTit}>
              ...
              <h3>{t('BXH.tigongtip')} {pool && pool.symbolPair && pool.symbolPair !== "" ? pool.symbolPair : ""} {t('BXH.zhuanquUSDT')}</h3>
            </div>
  ...
  nav = (pairData) => {
    ...
    this.props.history.push('/bxhTradeUSDTMobility/' + pairData.id)
  }
  changeReverse = () => {
...
export default withNamespaces()(withRouter(withStyles(styles)(BxhTradeUSDTStake)));
